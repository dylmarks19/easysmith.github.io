...
const COMPACT_MEWPS_CATEGORIES = [
  {
    id: "smp1", icon: "ti-building-arch", code: "SMP1", price: 91000,
    image: ["SMP1.png", "SMP1.2.png", "SMP1.3.png", "SMP1.mp4"],
  ...
  {
    id: "smp2", icon: "ti-building-arch", code: "SMP2", price: 133000,
    image: ["SMP2.png", "SMP2.2.png", "SMP2.3.png", "SMP2.mp4"],
  ...
  {
    id: "smd", icon: "ti-steering-wheel", code: "SMD", price: 270000,
    image: ["SMD.png", "SMD.2.png", "SMD.3.png", "SMD.mp4"],
  ...
  {
    id: "dmp1", icon: "ti-stack-2", code: "DMP1", price: 120000,
    image: ["DMP1.png", "DMP1.2.png", "DMP1.mp4"],
  ...
  {
    id: "dmp2", icon: "ti-stack-2", code: "DMP2", price: 169000,
    image: ["DMP2.png", "DMP2.2.png", "DMP2.3.png", "DMP2.mp4"],
  ...
  {
    id: "fmd", icon: "ti-stairs-up", code: "FMD", price: 496000,
    image: ["FMD.png", "FMD.2.png", "FMD.mp4"],
  ...
  {
    id: "fmt", icon: "ti-forklift", code: "FMT", price: 541000,
    image: ["FMT.png", "FMT.2.png", "FMT.mp4"],
  ...
  {
    id: "tmd", icon: "ti-arrows-up", code: "TMD", price: 199000,
    image: ["TMD.png", "TMD.2.png", "TMD.mp4"],
  ...
  {
    id: "tmt", icon: "ti-tank", code: "TMT", price: 211000,
    images: ["TMT.png", "TMT.2.png", "TMT.3.png", "TMT.4.png", "TMT.mp4"],
  ...
  {
    id: "x", icon: "ti-scissors", code: "X", price: 105000,
    images: ["XP.png", "XP.2.png", "XP.3.png", "XP.mp4"],
    title: "Scissor Lifts",
  ...
  {
    id: "ml", icon: "ti-package", code: "ML", price: 61000,
    images: ["MLP.png", "MLP.2.png", "MLP.3.png", "MLP.mp4"],
...
const PRODUCT_LINE_COMPACT_MEWPS = {
  ...
  icon: "ti-stairs-up",
  cataloguePdf: "Easysmith_MEWP_Product_Catalogue.pdf",
  cataloguePdfLabel: "Compact MEWPs Catalogue",
  leadTimes: {
    standard: "8–10 weeks",
    custom: "10–14 weeks",
