  ...
  el('home-cat-grid').innerHTML = CATEGORIES.map(cat => `
    <div class="cat-card" onclick="openCatModal('${cat.id}')">
      ...
      <div class="cat-body">
        ...
        <a class="btn btn-outline-navy" style="font-size:11px;padding:7px 12px;" onclick="event.stopPropagation(); openCatModal('${cat.id}')">View Models <i class="ti ti-arrow-right"></i></a>
      </div>
    </div>`
  ).join('');
