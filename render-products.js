...
function renderComparisonTable() {
    ...
    <th>
      <div style="display: flex; flex-direction: column; gap: 8px;">
        ...
        <div style="display: flex; gap: 6px; align-items: center; flex-wrap: wrap;">
          ...
          ` : ''}
          ${!allHidden ? `
            <button class="btn btn-ghost btn-sm" style="font-size: 10px; padding: 5px 8px; border-color: rgba(20,18,15,0.14); color: var(--text-faint);" onclick="clearComparisonColumns(event)">
  ...
  host.innerHTML = `
    ...
    <p class="sec-sub">Quickly compare specifications across all 11 Easysmith product series to find the right equipment class. Click the "X" on a column to hide it, or clear all and select exactly what you want to compare side-by-side.</p>
